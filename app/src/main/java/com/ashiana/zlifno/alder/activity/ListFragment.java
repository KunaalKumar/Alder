...
public class ListFragment extends Fragment {
    ...
    static ListIntents intents;

    public interface ListIntents {
        void newNote();
    }
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback =
                new ItemTouchHelper.SimpleCallback(ItemTouchHelper.DOWN | ItemTouchHelper.UP,
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                        ...
                        Snackbar.make(rootView.findViewById(R.id.coordinator_layout), "Note deleted", Snackbar.LENGTH_INDEFINITE)
                                .setDuration(5000)
                                .setAction("UNDO", v -> {
    ...
    private void initSpeedDial() {
        ...
        speedDialView.setOnChangeListener(new SpeedDialView.OnChangeListener() {
            ...
            public void onMainActionSelected() {
                Navigation.findNavController(rootView).navigate(R.id.action_listFragment_to_addTextNoteActivity);
            }
